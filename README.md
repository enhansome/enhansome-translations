...
* [LRM](https://github.com/nickprotop/LocalizationManager) ⭐ 51 | 🐛 2 | 🌐 CSS | 📅 2026-07-10 - Self-hosted CLI/TUI localization manager supporting .resx and JSON (i18next) with multiple translation providers including free options.
...
* [Traduora](https://github.com/traduora/traduora) ⭐ 2,130 | 🐛 99 | 🌐 JavaScript | 📅 2026-09-01 - A platform to manage translation workflow in teams.
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,088 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,823 | 🐛 127 | 🌐 Python | 📅 2026-09-03 - 100% Self-Hosted web app to translate text, based on Argos Translate.
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,458 | 🐛 30 | 🌐 Java | 📅 2026-09-23 - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,507 | 🐛 162 | 🌐 Python | 📅 2026-08-08 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,894 | 🐛 476 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
* [Translator](https://github.com/UlionTse/translators) ⭐ 2,710 | 🐛 10 | 🌐 Python | 📅 2026-01-26 - A translator library based on the translation interface of Google, Yandex, Microsoft (Bing), Baidu, Alibaba, Tencent, NetEase (Youdao), Sogou, Deepl, etc.
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 2,045 | 🐛 66 | 🌐 Python | 📅 2024-07-23 - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
* [Translate](https://github.com/translate/translate) ⭐ 980 | 🐛 238 | 🌐 Python | 📅 2026-09-25 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
...
* [SimpleLocalize CLI](https://github.com/simplelocalize/simplelocalize-cli) ⭐ 80 | 🐛 0 | 🌐 Java | 📅 2026-09-23 - A CLI for finding translation keys in project files.
