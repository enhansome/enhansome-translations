...
* [English](https://github.com/mbiesiad/awesome-translations) ⭐ 192 | 🐛 16 | 📅 2026-01-18
* [Polish](https://github.com/mbiesiad/awesome-translations/tree/pl_PL) ⭐ 192 | 🐛 16 | 📅 2026-01-18
...
* [Traduora](https://github.com/traduora/traduora) ⭐ 2,122 | 🐛 99 | 🌐 JavaScript | 📅 2026-08-05 - A platform to manage translation workflow in teams.
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,054 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,265 | 🐛 124 | 🌐 Python | 📅 2026-08-23 - 100% Self-Hosted web app to translate text, based on Argos Translate.
* [RTranslator](https://github.com/niedev/RTranslator) ⭐ 10,372 | 🐛 25 | 🌐 Java | 📅 2026-08-26 - A simultaneous translator app for Android based on NLLB and Whisper that runs locally.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,422 | 🐛 160 | 🌐 Python | 📅 2026-08-08 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,896 | 🐛 475 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
* [Translator](https://github.com/UlionTse/translators) ⭐ 2,695 | 🐛 10 | 🌐 Python | 📅 2026-01-26 - A translator library based on the translation interface of Google, Yandex, Microsoft (Bing), Baidu, Alibaba, Tencent, NetEase (Youdao), Sogou, Deepl, etc.
* [deep-translator](https://github.com/nidhaloff/deep-translator) ⭐ 2,041 | 🐛 66 | 🌐 Python | 📅 2024-07-23 - A flexible free and unlimited (depending on the translator used) library written in Python to translate between different languages in a simple way using multiple translators, it can also be used directly in the prompt.
* [Translate](https://github.com/translate/translate) ⭐ 976 | 🐛 234 | 🌐 Python | 📅 2026-09-01 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
* [Polyglot](https://github.com/untra/polyglot) ⭐ 496 | 🐛 6 | 🌐 Ruby | 📅 2026-08-21 - A fast, painless, open-source internationalization plugin for Jekyll blogs.
...
* [attranslate](https://github.com/fkirc/attranslate) ⭐ 358 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-24 - A tool for semi-automated translations of cross-platform apps or websites.
* [SwiftGoogleTranslate](https://github.com/maximbilan/SwiftGoogleTranslate) ⭐ 101 | 🐛 0 | 🌐 Swift | 📅 2026-06-27 - A framework to use cloud translation API by Google in Swift.
...
* [SimpleLocalize CLI](https://github.com/simplelocalize/simplelocalize-cli) ⭐ 78 | 🐛 1 | 🌐 Java | 📅 2026-08-08 - A CLI for finding translation keys in project files.
