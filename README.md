...
* [Traduora](https://github.com/traduora/traduora) ⭐ 2,125 | 🐛 99 | 🌐 JavaScript | 📅 2026-09-01 - A platform to manage translation workflow in teams.
...
* [Copy Translator](https://github.com/CopyTranslator/CopyTranslator) ⭐ 18,067 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-23 - An app for Windows, Mac and Linux that automatically translate and adapt a text when copied in the clipboard.
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 16,407 | 🐛 126 | 🌐 Python | 📅 2026-09-03 - 100% Self-Hosted web app to translate text, based on Argos Translate.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,457 | 🐛 161 | 🌐 Python | 📅 2026-08-08 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [Translate](https://github.com/translate/translate) ⭐ 977 | 🐛 232 | 🌐 Python | 📅 2026-09-12 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
