...
* [LibreTranslate](https://github.com/uav4geo/LibreTranslate) ⭐ 15,995 | 🐛 124 | 🌐 Python | 📅 2026-08-10 - 100% Self-Hosted web app to translate text, based on Argos Translate.
...
* [Argos Translate](https://github.com/argosopentech/argos-translate) ⭐ 6,365 | 🐛 157 | 🌐 Python | 📅 2026-08-08 - Completely open source offline translation app written in Python and based on OpenNMT. It can also be used as a Python library.
...
* [i18n Ally](https://github.com/antfu/i18n-ally) ⭐ 4,891 | 🐛 476 | 🌐 TypeScript | 📅 2024-12-13 - Extension for VSCode, all in one about i18n.
...
* [Translate](https://github.com/translate/translate) ⭐ 966 | 🐛 231 | 🌐 Python | 📅 2026-08-13 - A set of software and documentation designed to help make the lives of localizers both more productive and less frustrating.
...
* [Globalize](https://github.com/globalizejs/globalize) ⭐ 4,843 | 🐛 150 | 🌐 JavaScript | 📅 2025-09-29 - A JavaScript library for internationalization and localization that leverage the official Unicode CLDR JSON data.
